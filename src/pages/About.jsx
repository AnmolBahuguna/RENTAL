      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto mt-8">
          ...
          <div className="space-y-10 text-[22px] sm:text-2xl text-gray-600 italic font-medium leading-[1.8] sm:leading-[1.9] tracking-wide relative">
            ...
            <div className="absolute -top-6 -left-8 text-brand-200 text-6xl hidden sm:block opacity-50 font-serif">"</div>
          ...
          <div className="mt-20 text-center">
            ...
            <div className="w-16 h-1 bg-brand-500 rounded-full mx-auto mt-8 mb-6"></div>
          </div>
        </div>
