...
import { Filter, Grid, List as ListIcon, ChevronDown, Sparkles } from 'lucide-react'
...
export const Search = () => {
  ...
  useEffect(() => {
    setRecommendations(getRecommendedProperties())

    const handler = () => setRecommendations(getRecommendedProperties())
    window.addEventListener('goeazy_recommendations_updated', handler)
